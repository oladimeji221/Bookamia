						...
						<div class="px-4 px-md-5">
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-6">
									...
									<!-- Content -->
									<h5 class="fw-light">Bookamia made planning my Lagos trip so easy. I booked my hotel and event tickets all in one place. Absolutely brilliant!</h5>
									<!-- Rating -->
									...
									<!-- Title -->
									<h6 class="mb-0">Chidinma Okafor</h6>
									<span>Business Owner, Lagos</span>
								</div>
							</div>
						</div>
						<!-- Slide item END -->
						...
						<div class="px-4 px-md-5">
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-6">
									...
									<span class="display-3 mb-0 text-primary"><i class="bi bi-quote"></i></span>
									<!-- Content -->
									<h5 class="fw-light">I've been using Bookamia for cab bookings in Abuja. The service is fast and the drivers are always on time. Highly recommend!</h5>
									<!-- Rating -->
									<ul class="list-inline small mb-2">
										<li class="list-inline-item me-0"><i class="fa-solid fa-star text-warning"></i></li>
										<li class="list-inline-item me-0"><i class="fa-solid fa-star text-warning"></i></li>
									...
									<!-- Title -->
									<h6 class="mb-0">Emeka Nwosu</h6>
									<span>Software Engineer, Abuja</span>
								</div>
							</div>
						</div>
						<!-- Slide item END -->
